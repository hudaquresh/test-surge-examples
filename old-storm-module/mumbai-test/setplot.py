...
def setplot(plotdata=None):
    ...
    if storm_num == "test": 
        # TEST STORM LANDFALL 
        landfall_dt = datetime.datetime(2007, 11, 11, 8) - datetime.datetime(2007, 1, 1, 0)
    elif storm_num == "test_1200": 
        # TEST STORM LANDFALL FOR STORM 1200 
        landfall_dt = datetime.datetime(2003, 5, 17, 0) - datetime.datetime(2003, 1, 1, 0)
    elif storm_num == "test_1000": 
        # TEST STORM LANDFALL FOR STORM 1000 
        landfall_dt = datetime.datetime(1999, 10, 17, 0) - datetime.datetime(1999, 1, 1, 0) 
    elif storm_num == "test_0": 
        # TEST STORM LANDFALL FOR STORM 0 
        landfall_dt = datetime.datetime(1979, 10, 24, 14) - datetime.datetime(1979, 1, 1, 0) 
    elif storm_num == "test_1": 
        # TEST STORM LANDFALL FOR STORM 1 
        landfall_dt = datetime.datetime(1979, 11, 4, 8) - datetime.datetime(1979, 1, 1, 0) 
    ...
    #   Plot specifications
    # ==========================================================================
    regions = {"Full Domain (Grids)": {"xlimits": (clawdata.lower[0],
clawdata.upper[0]),
                                       "ylimits": (clawdata.lower[1],
clawdata.upper[1]),
                                       "figsize": (6.4, 4.8)},
               "LaTex Shelf": {"xlimits": (64.0, 78.0),
                               "ylimits": (17.5, 27.5),
                               "figsize": (8, 2.7)}}
    ...
    plotaxes = plotfigure.new_plotaxes()
    plotaxes.xlimits = regions['Full Domain (Grids)']['xlimits']
    plotaxes.ylimits = regions['Full Domain (Grids)']['ylimits']
    ...
    plotaxes.scaled = True
    plotaxes.xlimits = [71.5, 73.5]
    plotaxes.ylimits = [17.5, 19.5]
