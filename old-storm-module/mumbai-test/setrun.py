...
if storm_num == "test":
    # TEST STORM LANDFALL 
    landfall = datetime.datetime(2007, 11, 11, 8) - datetime.datetime(2007, 1,
1, 0)
elif storm_num == "test_1200": 
    # TEST STORM LANDFALL FOR STORM 1200 
    landfall = datetime.datetime(2003, 5, 17, 0) - datetime.datetime(2003, 1, 
1, 0) 
elif storm_num == "test_1000": 
    # TEST STORM LANDFALL FOR STORM 1000 
    landfall = datetime.datetime(1999, 10, 17, 0) - datetime.datetime(1999, 1, 
1, 0) 
elif storm_num == "test_0": 
    # TEST STORM LANDFALL FOR STORM 0 
    landfall = datetime.datetime(1979, 10, 24, 14) - datetime.datetime(1979, 1, 
1, 0)
elif storm_num == "test_1": 
    # TEST STORM LANDFALL FOR STORM 1 
    landfall = datetime.datetime(1979, 11, 4, 8) - datetime.datetime(1979, 1, 
1, 0)
...
#------------------------------
    ...
    clawdata.lower[1] = 0       # south latitude
...
degree_factor
    ...
    if clawdata.output_style==1:
        ...
        clawdata.tfinal = days2seconds(landfall.days + 5.0) + landfall.seconds
        recurrence = 4
...
rundata.clawdata.t0, rundata.clawdata.tfinal]) 
    rundata.gaugedata.gauges.append([4, 72.5, 18.5,
rundata.clawdata.t0, rundata.clawdata.tfinal]) 
...
#-------------------
    ...
    geo_data.sea_level = 2.00  # Due to seasonal swelling of gulf
