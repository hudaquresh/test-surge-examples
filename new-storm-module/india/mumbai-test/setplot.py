...
def setplot(plotdata=None):  
    ...
    #
    #if storm_num == 122: 
    #    landfall_dt = datetime.datetime(1981,10,31,20) - \
    #                    datetime.datetime(1981,1,1,0)
    #if storm_num == 546: 
    #    landfall_dt = datetime.datetime(1989, 12, 31, 14) - \
    #                    datetime.datetime(1989, 1,1, 0) 
 
    #if storm_num == 1002:  
    #    landfall_dt = datetime.datetime(1999, 10, 6, 2) - \
    #                    datetime.datetime(1999, 1,1, 0) 
    ...
    #   Plot specifications
    # ==========================================================================
    regions = {"Full Domain (Grids)": {"xlimits": (clawdata.lower[0], clawdata.upper[0]),
